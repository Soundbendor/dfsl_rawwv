...
def metric_creator(num_classes=50, multilabel = False, threshold = 0.5, device='cpu'):
    ...
    if multilabel == False:
        ...
        mdict["hamming_macro"] = TMC.HammingDistance(task="multilabel", threshold=threshold, average="macro", num_labels = num_classes, device=device)
        mdict["hamming_micro"] = TMC.HammingDistance(task="multilabel", threshold=threshold, average="micro", num_labels = num_classes, device=device)
        mdict["exact_match"] = TMC.ExactMatch(task="multilabel", num_labels= num_classes, device=device)
        mdict["f1_macro"] = TMC.F1Score(task="multilabel", threshold=threshold, average="macro", num_labels = num_classes, device=device)
        mdict["f1_micro"] = TMC.F1Score(task="multilabel", threshold=threshold, average="micro", num_labels = num_classes, device=device)
        mdict["acc_macro"] = TMC.Accuracy(task="multilabel", threshold=threshold, average="macro", num_labels = num_classes, device=device)
        mdict["acc_micro"] = TMC.Accuracy(task="multilabel", threshold=threshold, average="micro", num_labels = num_classes, device=device)
        mdict["prec_macro"] = TMC.Precision(task="multilabel", threshold=threshold, average="macro", num_labels = num_classes, device=device)
        mdict["prec_micro"] = TMC.Precision(task="multilabel", threshold=threshold, average="micro", num_labels = num_classes, device=device)
        mdict["avgprec_macro"] = TMC.AveragePrecision(task="multilabel", average="macro", num_labels = num_classes, device=device)
        mdict["avgprec_micro"] = TMC.AveragePrecision(task="multilabel", average="micro", num_labels = num_classes, device=device)
        mdict["auroc_macro"] = TMC.AUROC(task="multilabel", average="macro", num_labels = num_classes, device=device)
        mdict["auroc_micro"] = TMC.AUROC(task="multilabel", average="micro", num_labels = num_classes, device=device)
        mdict["confmat"] = TMC.ConfusionMatrix(task="multilabel", threshold=threshold, num_labels = num_classes, device=device)
