...
DEF_TAUDEVDIR = os.path.join(DEF_DATADIR, 'tau_urban_acoustic_scenes_2019', 'TAU-urban-acoustic-scenes-2019-development') 
...
ESC50_NUMCLASSES = [30,10,10]
ESC50_NUMCLASSES_TOTAL = np.sum(ESC50_NUMCLASSES)
TAU_NUMCLASSES = [5,5,0]
TAU_NUMCLASSES_TOTAL = np.sum(TAU_NUMCLASSES)
